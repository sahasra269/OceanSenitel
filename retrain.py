...
# Use tf.io.gfile instead of the old gfile module
gfile = tf.io.gfile
...
if __name__ == '__main__':
  ...
  parser.add_argument('--validation_batch_size', type=int, default=100, help='How many images to use in an evaluation batch.')
